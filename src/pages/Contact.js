...
import CompanyOverview from "../Layouts/CompanyOverview";
...
return (
   ...
   <div className="container mx-auto py-10">
      <div className="lg:flex">
        <div className="xl:w-2/5 lg:w-2/5 bg-gradient-to-l from-cyan-500 to-blue-500 py-3 py-16 xl:rounded-bl rounded-tl rounded-tr xl:rounded-tr-none">
          <div className="xl:w-5/6 xl:px-0 px-8 mx-auto">
            ...
            We provide detailed Weather Forecasts over a 7 day period updated four times a day. Our interactive weather maps can be customized to show forecasts of temperature, weather and wind
            </p>
            ...
            <div className="flex items-center">
              ...
              <p className="pl-4 text-white text-base">Info@mail.am</p>
            </div>
            <p className="text-lg text-white pt-10 tracking-wide">
               Yerevan
              <br />
              Yerevan F.Rusvelt 15
            </p>
          </div>
        </div>
        <div className="xl:w-3/5 lg:w-3/5 bg-gray-200  py-5 xl:pr-5 xl:pl-0 rounded-tr rounded-br">
          ...
          >
            ...
            <div className="w-full mt-6">
              ...
              <button
                type="submit"
                className="focus:outline-none bg-green-500 transition duration-150 ease-in-out hover:bg-green-600 rounded text-white px-8 py-3 text-sm leading-6"
              >
                Confirm
              </button>
            </div>
